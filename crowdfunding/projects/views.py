...
class ProjectDetail(APIView):
    ...
    def get_object(self,pk):
        try:
            queryset = Pledge.objects.all().filter(is_deleted=False)
            projects = Project.objects.all().filter(is_deleted=False).prefetch_related(Prefetch('pledges',queryset=queryset))
